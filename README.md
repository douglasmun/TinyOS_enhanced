...
A plain SHA-256 is also given in the [release notes](../../releases/tag/v2.2) for a quick integrity check. Either way, this is an educational OS — only run it in a throwaway VM.
